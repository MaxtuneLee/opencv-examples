...
class my_nanodet():
    def __init__(self,net , input_shape=320, prob_threshold=0.4, iou_threshold=0.3):
        ...
        for i in range(len(self.strides)):
            anchors = self._make_grid(
                (int(self.input_shape[0] / self.strides[i]), int(self.input_shape[1] / self.strides[i])),
                self.strides[i])
